...
def process_ldl(df, value_col):
    ...
    ldl_breaks = np.arange(0.1, 16, 1.5)
...
def main():
    # File paths
    input_path = "/Users/harisa/Documents/sdu/privateAim/flame/data_node1/synth_dataset.csv"
    output_folder = "/Users/harisa/Documents/sdu/privateAim/flame/results/lab_density"
    zip_path = os.path.join(output_folder, "lab_density_outputs.zip")
